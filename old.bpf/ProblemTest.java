...
public class ProblemTest
{
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInRow(1, 11));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInCol(9, 11));               
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInCol(7, 25));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.usedInCol(1, 80));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInBlock(1, 11));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInBlock(9, 11));               
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.usedInBlock(1, 80));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.numberNotUsed(9, 11));               
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.numberNotUsed(7, 25));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.numberNotUsed(1, 80));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.validEntry("1"));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.validEntry("0"));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(true, problem2.validEntry("5"));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.validEntry("10"));                
    }
    ...
    {
        Problem problem2 = new Problem();
        assertEquals(false, problem2.validEntry("-1"));                
    }
